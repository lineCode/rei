#if 0
rm -f a.out
cc main.c ../rei/rei.c ../glfw/lib/libglfw.so.3 -lGL -lm
...
int main() {
  ...
  reiTextureInitialize(ctx, REI_TEXTURE_BINDING_CUBE, REI_SAMPLER_FILTERING_LINEAR, REI_SAMPLER_FILTERING_LINEAR_MIP_LINEAR, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_CLAMP_TO_EDGE_VALUE, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_CLAMP_TO_EDGE_VALUE, 1, 1);
  reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_CUBE_POSITIVE_X, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, cube_w, cube_h, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, cube_px);
  reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_CUBE_NEGATIVE_X, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, cube_w, cube_h, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, cube_nx);
  reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_CUBE_POSITIVE_Y, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, cube_w, cube_h, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, cube_py);
  reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_CUBE_NEGATIVE_Y, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, cube_w, cube_h, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, cube_ny);
  reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_CUBE_POSITIVE_Z, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, cube_w, cube_h, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, cube_pz);
  reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_CUBE_NEGATIVE_Z, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, cube_w, cube_h, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, cube_nz);
  ...
  reiCommandListSet(ctx, list);
    ...
    mesh_skybox_state.viewportX                                      = 0;
    mesh_skybox_state.viewportY                                      = 0;
    mesh_skybox_state.viewportWidth                                  = 700;
    mesh_skybox_state.viewportHeight                                 = 700;
    mesh_skybox_state.scissorX                                       = 0;
    mesh_skybox_state.scissorY                                       = 0;
    mesh_skybox_state.scissorWidth                                   = 700;
    mesh_skybox_state.scissorHeight                                  = 700;
    ...
    mesh_state.viewportX                                      = 0;
    mesh_state.viewportY                                      = 0;
    mesh_state.viewportWidth                                  = 700;
    mesh_state.viewportHeight                                 = 700;
    mesh_state.scissorX                                       = 0;
    mesh_state.scissorY                                       = 0;
    mesh_state.scissorWidth                                   = 700;
    mesh_state.scissorHeight                                  = 700;
