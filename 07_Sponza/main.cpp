...
cc main.c meshes.o ../rei/rei.c ../glfw/lib/libglfw.so.3 -lGL -lm
...
int main() {
  ...
  for (int i = 0; i < SUBMESH_COUNT; i += 1) {
    if (textures[i] == NULL) {
      ...
      reiTextureInitialize(ctx, REI_TEXTURE_BINDING_2D, REI_SAMPLER_FILTERING_NEAREST, REI_SAMPLER_FILTERING_NEAREST, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_REPEAT, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_REPEAT, 1, 0);
      reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_2D, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, 2, 2, REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, nil_texture);
    ...
    if (// Foliage:
        ...
        i == SPONZA_349)
    {
      reiTextureInitialize(ctx, REI_TEXTURE_BINDING_2D, REI_SAMPLER_FILTERING_LINEAR, REI_SAMPLER_FILTERING_LINEAR_MIP_LINEAR, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_REPEAT, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_REPEAT, 1, 1);
    } else {
      reiTextureInitialize(ctx, REI_TEXTURE_BINDING_2D, REI_SAMPLER_FILTERING_LINEAR, REI_SAMPLER_FILTERING_LINEAR_MIP_LINEAR, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_REPEAT, REI_SAMPLER_BEHAVIOR_OUTSIDE_TEXTURE_COORDINATE_REPEAT, 8, 1);
    }
    reiTextureDefineAndUploadTexels(ctx, REI_TEXTURE_BINDING_2D, 0, REI_TEXTURE_TEXEL_FORMAT_RGBA, textures_w[i], textures_h[i], REI_TEXTURE_TEXEL_FORMAT_RGBA, REI_TEXTURE_TEXEL_TYPE_UBYTE, 4, textures[i]);
    reiBindTextureToActiveTextureSlot(ctx, REI_TEXTURE_BINDING_2D, 0);
  }
  ...
  reiCommandListSet(ctx, list);
    ...
    mesh_state.viewportWidth                                  = 1280;
    mesh_state.viewportHeight                                 = 720;
    mesh_state.scissorX                                       = 0;
    mesh_state.scissorY                                       = 0;
    mesh_state.scissorWidth                                   = 1280;
    mesh_state.scissorHeight                                  = 720;
  ...
  reiCommandListSet(ctx, list_with_blend);
    ...
    mesh_state_with_blend.viewportX                                      = 0;
    mesh_state_with_blend.viewportY                                      = 0;
    mesh_state_with_blend.viewportWidth                                  = 1280;
    mesh_state_with_blend.viewportHeight                                 = 720;
    mesh_state_with_blend.scissorX                                       = 0;
    mesh_state_with_blend.scissorY                                       = 0;
    mesh_state_with_blend.scissorWidth                                   = 1280;
    mesh_state_with_blend.scissorHeight                                  = 720;
  ...
  for (float pos_x = 0, pos_y = 7, pos_z = 0, rot_x = 0, rot_y = 0; glfwWindowShouldClose(window) == 0; glfwPollEvents()) {
    double mouse_x = 0;
    double mouse_y = 0;
